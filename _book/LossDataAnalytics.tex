...
\chapter{AggregateLossModelTEXTEST}\label{aggregatelossmodeltextest}

\emph{Example. Course 3, May 2000, 19.} An insurance company sold 300
...
\caption{\label{tab:unnamed-chunk-1}A table of the first 10 rows of the mtcars data.}
\centering
